...
public class ScintillaSeeds extends ItemSeeds implements IPlantable, IAgriCraftSeed
{
	...
	public String getInformation() {
		return "A shiny wheat grain that sparkles faintly, seed of the scintilla wheat plant.";
	}
