...
@Mod(modid="ashenwheat", name="Ashenwheat", version="1.7.10-1.2.2",
...
public class AshenWheatCore
{
   ...
   public static AshenWheatCore instance;
    ...
    @SidedProxy(clientSide = "akkamaddi.ashenwheat.code.ClientProxy", 
    			serverSide = "akkamaddi.ashenwheat.code.CommonProxy")
   ...
   @EventHandler
    public void preInit(FMLPreInitializationEvent event)
    {
		...
		ashSeeds = new AshSeeds(ashWheatCrop, Blocks.farmland).setCreativeTab(AshenWheatCore.tabAshenwheat);
		...
		scintillaWheatSheaf = new ScintillaWheatSheaf().setCreativeTab(AshenWheatCore.tabAshenwheat);
		scintillaWheatCrop = new ScintillaWheatCrop();
		scintillaSeeds = new ScintillaSeeds(scintillaWheatCrop, Blocks.farmland).setCreativeTab(AshenWheatCore.tabAshenwheat);
        ...
        if (seedsInChests) {
			ChestGenHooks.getInfo(ChestGenHooks.PYRAMID_JUNGLE_CHEST).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.ashSeeds), 2, 8, 20));
			ChestGenHooks.getInfo(ChestGenHooks.PYRAMID_JUNGLE_CHEST).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.scintillaSeeds), 2, 4, 10));
			ChestGenHooks.getInfo(ChestGenHooks.PYRAMID_JUNGLE_CHEST).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.ossidSeeds), 2, 6, 15));
			ChestGenHooks.getInfo(ChestGenHooks.PYRAMID_JUNGLE_CHEST).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.thunderSeeds), 2, 6, 15));

			ChestGenHooks.getInfo(ChestGenHooks.PYRAMID_DESERT_CHEST).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.scintillaSeeds), 4, 8, 16));
			ChestGenHooks.getInfo(ChestGenHooks.PYRAMID_DESERT_CHEST).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.scintillaWheatSheaf), 2, 4, 6));
			ChestGenHooks.getInfo(ChestGenHooks.PYRAMID_DESERT_CHEST).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.ashCookie), 6, 16, 12));
			ChestGenHooks.getInfo(ChestGenHooks.PYRAMID_DESERT_CHEST).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.scintillaCookie), 6, 16, 12));

			ChestGenHooks.getInfo(ChestGenHooks.VILLAGE_BLACKSMITH).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.ashSeeds), 2, 6, 10));
			ChestGenHooks.getInfo(ChestGenHooks.VILLAGE_BLACKSMITH).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.scintillaSeeds), 1, 3, 2));
			ChestGenHooks.getInfo(ChestGenHooks.VILLAGE_BLACKSMITH).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.ossidSeeds), 2, 4, 5));
			ChestGenHooks.getInfo(ChestGenHooks.VILLAGE_BLACKSMITH).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.thunderSeeds), 2, 4, 5));

			ChestGenHooks.getInfo(ChestGenHooks.VILLAGE_BLACKSMITH).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.ashWheatSheaf), 2, 4, 5));
			ChestGenHooks.getInfo(ChestGenHooks.VILLAGE_BLACKSMITH).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.scintillaWheatSheaf), 1, 3, 2));
			ChestGenHooks.getInfo(ChestGenHooks.VILLAGE_BLACKSMITH).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.ashCookie), 6, 16, 4));
			ChestGenHooks.getInfo(ChestGenHooks.VILLAGE_BLACKSMITH).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.scintillaCookie), 6, 16, 2));

			ChestGenHooks.getInfo(ChestGenHooks.DUNGEON_CHEST).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.ashSeeds), 2, 6, 15));
			ChestGenHooks.getInfo(ChestGenHooks.DUNGEON_CHEST).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.scintillaSeeds), 1, 3, 5));
			ChestGenHooks.getInfo(ChestGenHooks.DUNGEON_CHEST).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.ossidSeeds), 2, 4, 10));
			ChestGenHooks.getInfo(ChestGenHooks.DUNGEON_CHEST).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.thunderSeeds), 2, 4, 10));

			ChestGenHooks.getInfo(ChestGenHooks.MINESHAFT_CORRIDOR).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.ashSeeds), 1, 4, 3));
			ChestGenHooks.getInfo(ChestGenHooks.MINESHAFT_CORRIDOR).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.scintillaSeeds), 1, 2, 1));
			ChestGenHooks.getInfo(ChestGenHooks.MINESHAFT_CORRIDOR).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.ossidSeeds), 1, 3, 2));
			ChestGenHooks.getInfo(ChestGenHooks.MINESHAFT_CORRIDOR).addItem(
					new WeightedRandomChestContent(new ItemStack(
							AshenWheatCore.thunderSeeds), 1, 3, 2));
        } // end-if chests
   ...
   public void initAgriCraft()
   {
		...
		apiv2.registerCropPlant(new AgriAshenWheat());
		apiv2.registerCropPlant(new AgriScintillaWheat());
